...
</div>`})})]}),o("div",{className:"panel",children:[o("div",{className:"flex items-center justify-between mb-5",children:[e("h5",{className:"font-semibold text-lg dark:text-white-light",children:"Overlay"}),e("button",{onClick:()=>{b("code2")},className:"font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600",children:o("span",{className:"flex items-center",children:[e(E,{className:"me-2"}),"Code"]})})]}),e("div",{className:"mb-5 space-y-5",children:e("form",{children:e(q,{onClickAway:N,children:o("div",{className:"search-form-overlay relative border border-white-dark/20 rounded-md h-12 w-full",onClick:g,children:[e("input",{type:"text",placeholder:"Search...",className:`form-input bg-white h-full placeholder:tracking-wider hidden ltr:pl-12 rtl:pr-12 peer ${m?"!block":""}`}),e("button",{type:"button",className:`text-dark/70 absolute ltr:right-1 rtl:left-1 inset-y-0 my-auto w-9 h-9 p-0 flex items-center justify-center peer-focus:text-primary ${m?"!ltr:!right-auto ltr:left-1 rtl:right-1":""}`,children:e(S,{className:"mx-auto w-5 h-5"})})]})})})}),a.includes("code2")&&e(L,{children:e("pre",{children:`import { useState} from 'react';
